...
_C.DATASET.TRAIN_SET = 'mpii'
_C.DATASET.EVAL_SET = 'mpii'
...
_C.TRAIN.BEGIN_ITER = 0
_C.TRAIN.END_ITER = 140
_C.TRAIN.EVAL_ITER = 0
...
def update_config(cfg, args, simple=False):
    cfg.defrost()
